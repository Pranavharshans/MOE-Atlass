...
| §§12–14 server and UI | `moeatlas.server` (DTOs + app), `moeatlas ui`, `frontend/` | TestClient endpoint/static-bundle suites, launch-policy suites, local browser smoke | model-free complete at the packaged/static boundary; broad browser E2E and VM execution evidence remain deferred |
