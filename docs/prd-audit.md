...
| §§12–14 server and UI | `moeatlas.server` (DTOs + app), `moeatlas ui` | TestClient endpoint suites, launch-policy suites | model-free complete at the wire boundary; React SPA and browser E2E are deferred release evidence |
