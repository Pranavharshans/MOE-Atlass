...
def build_parser() -> argparse.ArgumentParser:
    """Create the CLI parser without importing optional runtimes."""
    ...
    return build_cli_parser(
        ...
        handlers={
            ...
            "routing_runs": _handle_routing_runs,
            "compare": _handle_compare,
            "adapters_list": _handle_adapters_list,
            "run": _handle_run,
...
def _run_routing_run_inventory(
    ...
    *,
    ...
    from .store import list_routing_runs
